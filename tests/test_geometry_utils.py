...
class TestGeometryUtils(unittest.TestCase):
    ...
    def test_roads_intersect(self):
        ...
        self.assertFalse(
            roads_intersect(road3_start, road3_end, road4_start, road4_end)
        )
    ...
    def test_point_too_close_to_line(self):
        ...
        # 線分に近い点
        self.assertTrue(
            point_too_close_to_line(5, 2, line_start, line_end, min_distance=5)
        )

        # 線分から遠い点
        self.assertFalse(
            point_too_close_to_line(5, 10, line_start, line_end, min_distance=5)
        )

        # 線分上の点
        self.assertTrue(
            point_too_close_to_line(5, 0, line_start, line_end, min_distance=1)
        )
    ...
    def test_point_too_close_to_line_edge_cases(self):
        ...
        self.assertTrue(
            point_too_close_to_line(
                5, 5, point_line_start, point_line_end, min_distance=1
            )
        )
        self.assertFalse(
            point_too_close_to_line(
                10, 10, point_line_start, point_line_end, min_distance=1
            )
        )
        ...
        # 端点の外側
        self.assertTrue(
            point_too_close_to_line(-1, 0, line_start, line_end, min_distance=2)
        )
        self.assertTrue(
            point_too_close_to_line(11, 0, line_start, line_end, min_distance=2)
        )
